...
module.exports.routes = {
  ...
  'GET /anzac/:token':                                   { action: 'promotions/create-limited-auth'},
  'GET /anzac':                                          { action: 'promotions/view-expired-promo'},
  'GET /anzac/success':                                  { action: 'promotions/view-expired-promo'},
  'GET /freedom-day/:token':                             { action: 'promotions/create-limited-auth'},
  'GET /freedom-day':                                    { action: 'promotions/view-expired-promo'},
  'GET /freedom-day/success':                            { action: 'promotions/view-expired-promo'},
  'GET /kings-day/:token':                          { action: 'promotions/create-limited-auth'},
  'GET /kings-day':                                 { action: 'promotions/view-expired-promo'},
  'GET /kings-day/success':                         { action: 'promotions/view-promo-success'},
  'GET /mothers-day/':                                   { action: 'promotions/view-expired-promo'},
  'GET /mothers-day/:token':                             { action: 'promotions/create-limited-auth'},
  'GET /mothers-day/success':                            { action: 'promotions/view-gift-success'},
  // 'GET /memorial-day/':                                  { action: 'promotions/memorial-day/view-promo'},
  'GET /memorial-weekend/':                              { action: 'promotions/memorial-day/view-promo-alt'},
  // 'GET /memorial-day/:token':                            { action: 'promotions/create-limited-auth'},
  'GET /memorial-weekend/:token':                        { action: 'promotions/create-limited-auth'},
  // 'GET /memorial-day/success':                           { action: 'promotions/view-promo-success'},
