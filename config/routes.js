...
module.exports.routes = {
  ...
  'GET /vocabulary/*':                                   'HomeController.serve',
  ...
  'GET /recap/upload-files/:lessonId?/:unused?':         'RecapController.serve',
  'GET /recapsubmit/:lessonId?/:unused?':                'RecapController.serve',
  ...
  'GET /anzac-2020':                                     { action: 'promotions/view-expired-promo'},
  'GET /anzac-2020/success':                             { action: 'promotions/view-expired-promo'},
  'GET /freedom-day-2020/:token':                        { action: 'promotions/create-limited-auth'},
  'GET /freedom-day-2020':                               { action: 'promotions/view-expired-promo'},
  'GET /freedom-day-2020/success':                       { action: 'promotions/view-expired-promo'},
