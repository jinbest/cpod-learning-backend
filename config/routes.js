...
module.exports.routes = {
  ...
  'GET /email-signup/:campaignId?':                      { action: 'entrance/view-signup' },
  // 'GET /email-signup/:campaignId':                       { action: 'entrance/link-campaign' },
  'GET /get-started/:campaignId?':                       { action: 'entrance/view-signup' },
  // 'GET /get-started/:campaignId':                        { action: 'entrance/link-campaign' },
  'GET /signup/:campaignId?':                            { action: 'entrance/view-signup' },
  // 'GET /signup/:campaignId':                             { action: 'entrance/link-campaign' },
  'GET /free-signup/:campaignId?':                       { action: 'entrance/view-free-signup' },
  // 'GET /free-signup/:campaignId':                        { action: 'entrance/link-campaign' },
  'GET /signup-free/:campaignId?':                       { action: 'view-homepage-or-redirect' },
  // 'GET /signup-free/:campaignId':                        { action: 'entrance/link-campaign' },
  'GET /why-choose-us/:campaignId?':                     { action: 'view-why-choose-us' },
  // 'GET /why-choose-us/:campaignId':                      { action: 'entrance/link-campaign' },
  'GET /start-learning-chinese/:campaignId?':            { action: 'view-start-learning-chinese' },
  // 'GET /start-learning-chinese/:campaignId':             { action: 'entrance/link-campaign' },
  'GET /start-learning-mandarin/:campaignId?':           { action: 'view-start-learning-mandarin' },
  // 'GET /start-learning-mandarin/:campaignId':            { action: 'entrance/link-campaign' },
  'GET /free-trial/:campaignId?':                        { action: 'view-free-trial' },
