module.exports = {
  ...
  fn: async function (inputs) {
    ...
    if (this.req.session.userId) {
      ...
      if (!inputs.code) {
        return this.res.view('pages/promotions/valentines/valentines-day-gift-redeem');
      }
      ...
      if (!voucher) {
        ...
        // INVALID VOUCHER
        return this.res.view('pages/promotions/valentines/valentines-day-gift-redeem', {formData: {code: inputs.code}})
      ...
      if (userSiteLinks && userSiteLinks.length > 0 && userSiteLinks[0]['usertype_id'] !== 7) {
        ...
        return this.res.view('pages/promotions/valentines/valentines-day-gift-redeem-confirm',{
          formData: {
            code: inputs.code,
        ...
        return this.res.redirect('/valentines-day-gift/redeem/success')
