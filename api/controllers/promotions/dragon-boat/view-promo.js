module.exports = {
  ...
  fn: async function (inputs) {
    let trial = false; let promo = true; let plan = 'premium'; let promoCode = 'DRAGON2020'; let nonRecurring = false; let permanentDiscount = true;
    ...
    // Respond with view.
    return this.res.view('pages/promotions/dragon-boat/promo',{
