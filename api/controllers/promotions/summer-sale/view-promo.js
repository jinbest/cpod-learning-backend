module.exports = {
  ...
  fn: async function (inputs) {
    let trial = false; let promo = true; let plan = 'premium'; let promoCode = 'SUMMERSALE'; let nonRecurring = false;

    let period = 'monthly' // inputs.annual ? 'annually' : 'quarterly';
    ...
    // Respond with view.
    return this.res.view('pages/promotions/summer-sale/promo',{
