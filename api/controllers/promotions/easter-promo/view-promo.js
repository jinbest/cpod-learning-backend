module.exports = {
  ...
  exits: {
    ...
    success: {
      viewTemplatePath: 'pages/promotions/easter-promo/promo'
    }
  ...
  fn: async function (inputs) {
    ...
    let trial = false; let promo = true; let plan = 'premium'; let period = 'annually'; let promoCode = 'EASTER2020'; let nonRecurring = false;
