module.exports = {
  ...
  fn: async function (inputs) {
    let trial = false; let promo = true; let plan = 'premium'; let promoCode = 'JULY4'; let nonRecurring = false;
    ...
    // Respond with view.
    return this.res.view('pages/promotions/independence-day/promo',{
