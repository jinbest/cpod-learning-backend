module.exports = {
  ...
  fn: async function (inputs) {
    ...
    let userVocab = await UserVocabulary.find({user_id: inputs.userId}).skip(inputs.skip).limit(inputs.limit).populate('vocabulary_id');
    ...
    return {
      ...
      vocabulary: userVocab.map(vocab => {
        ...
        return {...vocab.vocabulary_id, ...{user_vocabulary_id: vocab.id, createdAt: vocab.createdAt}}
      })
    }
  }
