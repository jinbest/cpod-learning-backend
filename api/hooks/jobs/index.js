...
module.exports = function defineJobsHook(sails) {
  ...
  triggerQueue.removeRepeatable('UpdateAllUsers',{repeat: {cron: '30 1 31 * *'}});
  // triggerQueue.removeRepeatable('UpdateAllUsers',{repeat: {cron: '0 1 * * *'}});
  triggerQueue.add('UpdateAllUsers', {data:'Push All User Data to Mautic once a Month'},{repeat: {cron: '30 1 31 * *'}});
