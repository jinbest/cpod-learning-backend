...
// OK.
  ...
  emailTriggerQueue.process('ScheduleInactivityEmailsProduction', 1, async function (job, done) {
    ...
    let userData = await sails.models['user'].find({email: {in: liveUsers}, id: {nin: spamList}});
  ...
  emailTriggerQueue.process('AddInactivityEmailLists', 1, async function (job, done) {
